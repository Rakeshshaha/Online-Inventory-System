    ...
    <div class="main-top-intro">
        <div class="bg-layer">
            ...
            <div class="wrapper">
                ...
                <!-- //header -->
                <section class="panel" style="background: rgba(0,0,0,0.4);padding: 2%;color: white;">
						<div class="panel-body">
							<div class="invoice">
								<header class="clearfix">
									<div class="row">
										<div class="col-sm-6 mt-md">
											<h2 class="h2 mt-none mb-sm  text-bold">INVOICE</h2>
								...
								<div class="table-responsive">
									<table class="table invoice-items" style="color: white;">
										<thead>
											<tr class="h4 ">
								...
								<div class="invoice-summary">
									<div class="row">
										...
										<div class="col-sm-4 col-sm-offset-8">
											<table class="table h5 text-light ">
												<tbody>
													<tr class="h4">
							...
							<div class="text-right mr-lg">
								<a href="invoice-print.php?sale_number=<?php echo $_GET['sale_number']; ?>" target="_blank" class="btn btn-primary ml-sm"><i class="fa fa-print"></i> Print</a>
							</div>
						</div>
					</section>
                <!-- copyright -->
